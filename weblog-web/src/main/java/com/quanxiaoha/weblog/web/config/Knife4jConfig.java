 ...
 *
 * @author 秋涩
 * @version Knife4jConfig.java, v 0.1 2024年07月21日 23:14 秋涩
 */

@Configuration
@EnableSwagger2WebMvc
@Profile("dev") //只有在dev环境才会开启Knife4j
public class Knife4jConfig {
    ...
    private ApiInfo buildApiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("犬小哈", "https://www.quanxiaoha.com", "805324374@qq.com")) // 联系人
                .version("1.0") // 版本号
                .build();
    }
}